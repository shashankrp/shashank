...
car3 = pygame.image.load('3.png')
car4 = pygame.image.load('4.png')
playerRect = playerImage.get_rect()
baddieImage = pygame.image.load('2.png')
sample = [car3, car4, baddieImage]
wallLeft = pygame.image.load('l.png')
wallRight = pygame.image.load('r.png')
